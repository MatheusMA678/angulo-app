        ...
        <div className='h-[120vh] plano-de-fundo2  flex  flex-col items-center'>
            <div className='flex flex-col items-center pt-6'>
                ...
                <ButtonGroup variant="outlined" className="pb-16 pt-6"  >
                    <Button
                        className={`rounded-full ${selectedPlano === 'mensal' ? 'bg-[#0b366b]' : 'bg-[#0755B5]'
                            } text-white`}
                    ...
                    <Button
                        className={`rounded-full ${selectedPlano === 'semestral' ? 'bg-[#0b366b]' : 'bg-[#0755B5]'
                            } text-white`}
                    ...
                    <Button
                        className={`rounded-full ${selectedPlano === 'anual' ? 'bg-[#0b366b]' : 'bg-[#0755B5]'
                            } text-white`}
